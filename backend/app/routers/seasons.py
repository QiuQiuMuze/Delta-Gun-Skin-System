...
from ..repositories import SeasonRepositoryProtocol
from ..state import get_season_repository_dependency

router = APIRouter(prefix="/seasons", tags=["seasons"])


def get_repository(
    repository: SeasonRepositoryProtocol = Depends(get_season_repository_dependency),
...
async def list_seasons(
    repository: SeasonRepositoryProtocol = Depends(get_repository),
) -> list[SeasonResponse]:
