  ...
  const Engine = {
    ...
    _musicPresets: {
      ...
      'dungeon-lobby': {
        ...
        chordStyle: 'sustain',
        chordOctave: -1,
        arpeggio: { amp: 0.22, subdivision: 2, span: 4, swing: 0.12, randomness: 0.2, pan: 0.18 },
        melody: { density: 0.4, resolution: 2, range: [-1, 4], legato: 1.3, vibrato: 0.02, detune: 0.003, accent: 0.28, spread: 0.26, randomness: 0.22 },
        atmosphere: { type: 'wind', amp: 0.08, motion: 0.28, swayFreq: 0.012 },
        pulse: { intervalBeats: 3, width: 1.2, amp: 0.14, freq: 60, shape: 'heartbeat', noise: 0.018, spread: 0.22 }
      },
      'dungeon-explore': {
        key: 'dungeon-explore-v1',
        seed: 73452,
        tempo: 72,
        scale: 'mystic',
        root: 220,
        ...
        chordStyle: 'sustain',
        chordOctave: -1,
        arpeggio: { amp: 0.26, subdivision: 3, span: 5, randomness: 0.26, swing: 0.1, pan: 0.2 },
        melody: { density: 0.45, resolution: 3, range: [-2, 5], legato: 1.1, vibrato: 0.018, detune: 0.004, accent: 0.34, spread: 0.32, randomness: 0.28 },
        percussion: {
          amp: 0.18,
          resolution: 3,
          hat: { rate: 1.4, randomness: 0.28, cutoff: 0.46, pan: -0.1 },
          shaker: { rate: 0.6, randomness: 0.24, pan: 0.18 }
        },
        pulse: { intervalBeats: 2.5, width: 1, amp: 0.18, freq: 84, shape: 'swell', noise: 0.02, spread: 0.26 },
        atmosphere: { type: 'wind', amp: 0.07, motion: 0.34, swayFreq: 0.01 }
      },
      'dungeon-event': {
        key: 'dungeon-event-v1',
        seed: 84563,
        tempo: 64,
        scale: 'mystic',
        root: 196,
        ...
        chordStyle: 'drone',
        chordOctave: -2,
        arpeggio: { amp: 0.18, subdivision: 2, span: 4, randomness: 0.3, swing: 0.14, pan: 0.16 },
        melody: { density: 0.35, resolution: 2, range: [-2, 4], legato: 1.6, vibrato: 0.028, detune: 0.006, accent: 0.26, spread: 0.3, randomness: 0.26 },
        atmosphere: { type: 'wind', amp: 0.1, motion: 0.4, swayFreq: 0.015 },
        pulse: { intervalBeats: 3, width: 1.4, amp: 0.16, freq: 72, shape: 'heartbeat', noise: 0.018, spread: 0.24 },
        celestial: { amp: 0.2, density: 0.5, steps: [5, 9], octave: 2, shimmer: 0.38, drift: 0.12, vibrato: 0.05, sustain: 0.7 }
      },
      'dungeon-combat': {
        key: 'dungeon-combat-v1',
        seed: 92341,
        tempo: 108,
        scale: 'mystic',
        root: 220,
        ...
        chordStyle: 'stabs',
        chordOctave: -1,
        arpeggio: { amp: 0.32, subdivision: 4, span: 5, randomness: 0.32, swing: 0.08, pan: 0.2 },
        melody: { density: 0.6, resolution: 4, range: [-2, 5], legato: 0.8, vibrato: 0.024, detune: 0.008, accent: 0.52, spread: 0.36, randomness: 0.3 },
        percussion: {
          amp: 0.46,
          resolution: 4,
          kick: { pattern: [1, 0, 0.7, 0, 1, 0, 0.5, 0], decay: 2.8 },
          snare: { pattern: [0, 0, 1, 0], tone: 880, noise: 0.58 },
          hat: { rate: 2.4, randomness: 0.28, cutoff: 0.62, swing: 0.12 }
        },
        pulse: { intervalBeats: 0.75, width: 0.8, amp: 0.24, freq: 120, shape: 'gate', curve: 1.6, spread: 0.32 },
        bass: { subdivision: 2, length: 0.8, amp: 0.5, notes: [-12, -10, -15, -8], glide: 0.24, decay: 1.6, spread: 0.3 }
      },
      'dungeon-victory': {
        key: 'dungeon-victory-v1',
        seed: 81245,
        tempo: 72,
        scale: 'lydian',
        root: 220,
        ...
        chordStyle: 'sustain',
        chordOctave: -1,
        arpeggio: { amp: 0.24, subdivision: 2, span: 4, randomness: 0.2, swing: 0.16, pan: 0.22 },
        melody: { density: 0.5, resolution: 2, range: [-1, 5], legato: 1.4, vibrato: 0.02, detune: 0.003, accent: 0.4, spread: 0.34, randomness: 0.26 },
        celestial: { amp: 0.26, density: 0.7, steps: [4, 7, 9], octave: 2, shimmer: 0.42, drift: 0.16, vibrato: 0.05, sustain: 0.72 },
        pulse: { intervalBeats: 2, width: 1, amp: 0.2, freq: 96, shape: 'swell', noise: 0.015, spread: 0.28 }
      },
      'dungeon-defeat': {
        key: 'dungeon-defeat-v1',
        seed: 90451,
        tempo: 54,
        scale: 'mystic',
        root: 174,
        ...
        chordStyle: 'sustain',
        chordOctave: -2,
        arpeggio: { amp: 0.16, subdivision: 2, span: 4, randomness: 0.26, pan: 0.18 },
        melody: { density: 0.32, resolution: 2, range: [-3, 3], legato: 1.6, vibrato: 0.026, detune: 0.005, accent: 0.24, spread: 0.28, randomness: 0.24 },
        atmosphere: { type: 'wind', amp: 0.12, motion: 0.42, swayFreq: 0.013 },
        pulse: { intervalBeats: 4, width: 1.6, amp: 0.16, freq: 48, shape: 'heartbeat', noise: 0.02, spread: 0.2 },
        drone: { amp: 0.26, octave: -3, fifth: 0.36, shimmer: 0.18, vibrato: 0.012 }
      },
      'starfall-prelude': {
