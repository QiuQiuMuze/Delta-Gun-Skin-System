...
const DungeonData = (() => {
  const BALANCE_CONFIG = {
    ...
    player: {
      hpBonus: 6,
      energyBonusThreshold: 6,
      energyBonus: 1,
      defenseBonusCap: 4,
      defenseBonus: 1,
      attackBonusThreshold: 5,
      attackBonus: 1,
    },
  };
  const statuses = {
  ...
  const consumables = {
    small_heal: { id: "small_heal", name: "小治疗药水", type: "potion", description: "恢复少量HP。", effect: { heal: 18 } },
    ...
    ether: { id: "ether", name: "蓝药草", type: "potion", description: "恢复少量能量。", effect: { energy: 4 } },
    ...
    guard_tonic: { id: "guard_tonic", name: "守护药剂", type: "potion", description: "获得护甲与守备并小幅治疗。", effect: { armor: 2, guard: 1, heal: 8 } },
    thunder_scroll: { id: "thunder_scroll", name: "雷霆卷轴", type: "scroll", description: "对潮湿目标额外造成雷鸣打击。", effect: { damage: 10, stun: 1, bonusVsWet: 6 } },
    valor_banner: { id: "valor_banner", name: "勇气旌旗", type: "tactic", description: "鼓舞士气，立即获得勇气并恢复能量。", effect: { heroism: 1, energy: 3 } },
    mending_salve: { id: "mending_salve", name: "愈合膏", type: "salve", description: "缓缓愈合，解除一个流血或中毒。", effect: { heal: 10, cleanse: ["bleed", "poison"] } },
    iron_biscuit: { id: "iron_biscuit", name: "铁味干粮", type: "food", description: "咬起来如钉，能补充体力。", effect: { heal: 12, armor: 1 } },
    ...
    berserk_draught: { id: "berserk_draught", name: "狂怒药剂", type: "potion", description: "饮下后激发怒意，恢复生命并点燃斗志。", effect: { heal: 14, inspire: 1 } },
    focus_bead: { id: "focus_bead", name: "静心念珠", type: "charm", description: "以禅意抚平伤势并驱散毒素。", effect: { heal: 10, cleanse: ["bleed", "poison"] } },
    gadget_charge: { id: "gadget_charge", name: "机械充能瓶", type: "potion", description: "恢复能量并生成护幕。", effect: { energy: 4, guard: 1 } },
    sapling_totem: { id: "sapling_totem", name: "青木护符", type: "totem", description: "唤起小型树灵协助，恢复生命并提升勇气。", effect: { heal: 12, heroism: 1 } },
    storm_vial: { id: "storm_vial", name: "闪潮瓶", type: "potion", description: "雷潮在瓶中翻滚，饮下可恢复能量并激励。", effect: { energy: 3, inspire: 1 } },
    spirit_lantern: { id: "spirit_lantern", name: "幽灵提灯", type: "charm", description: "借灯火守护心神，恢复生命并获得守备。", effect: { heal: 9, guard: 1, heroism: 1 } },
    time_dust: { id: "time_dust", name: "沙漏余尘", type: "potion", description: "吸入尘末，令时间稍缓，恢复少量能量。", effect: { energy: 3, inspire: 1 } }
  };
...
class DungeonGame {
  ...
  commandRest() {
    ...
    const player = this.run.player;
    const healed = this.healPlayer(16, { context: 'explore' });
    this.adjustCorruption(1);
  ...
  handleCamp(mode) {
    ...
    if (mode === 'rest') {
      const healed = this.healPlayer(28, { context: 'camp' });
